...
import com.ssh.dao.base.PageResults;
...
public class BaseDaoImpl<T, ID extends Serializable> implements IBaseDao<T, ID> {
	 ...
	 *      java.lang.Object[])
	 */
	public <V> List<V> getListBySQL_JDBC(Class<V> cls, String sqlString,
			Object... values) {
		RowMapper<V> rm = ParameterizedBeanPropertyRowMapper.newInstance(cls);
		return new JdbcTemplate(dataSource).query(sqlString, values, rm);
	}
