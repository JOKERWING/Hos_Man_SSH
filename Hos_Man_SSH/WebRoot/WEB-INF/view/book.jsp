...
<script>
	$(function() {
		$.datepicker._gotoToday = function () {
            $("#indate").datepicker('setDate', new Date()).datepicker('hide').blur();
        };
		$("#indate").datepicker({
			minDate : new Date()
		});
						...
						<ul>
							<li class="span1_of_1 ">
								...
								<div class="section_room ">
									<select id="type" onchange="selallhot();"
							...
							<li class="span1_of_1 left ">
								...
								<div class="book_date ">
									<input class="date" id="indate" type="text" value="年-月-日"
										onblur="if (this.value == '') {this.value = '年-月-日';}" onchange="selallhot();">
								</div>
							</li>
							<li class="span1_of_1 left ">
								<h5>退房日期:</h5>
							...
							<li class="span1_of_2 left ">
								...
								<div class="section_room ">
									<select id="pnum" onchange="selallhot();""
										class="frm-field required">
			...
			<div class="footer">
				...
				<div class="f_nav">
					<ul id="end">
						...
						<li><a href="rooms.html">套房</a></li>
						<li><a href="activities.jsp">预订</a></li>
...
function sethotel() {
	...
	indate1=mydate.getFullYear()+"-"+parseInt(mydate.getMonth()+1) +"-"+mydate.getDate();
	var nextdate = new Date(mydate.getTime() + 24 * 60 * 60 * 1000);
	//outdate1 = nextdate.toLocaleDateString();
	outdate1=nextdate.getFullYear()+"-"+parseInt(nextdate.getMonth()+1) +"-"+nextdate.getDate();
						...
						$
								.each(
										...
										function(i, n) {
											...
											str += "<li><div class='ser_img '><a href='HosMan/rooms?type="+name+"' > <img src='Picture/"+n.hiType+".jpg' alt='' />"
													+ "</a></div> <a href='HosMan/rooms?type="+name+"'><h3>"
													+ name
													+ "</h3></a><p class='para'>"
													+ "房间号："
													+ n.hId
