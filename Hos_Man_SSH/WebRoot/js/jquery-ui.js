...
*/		closeText: '关闭', // Display text for close link
		...
		dayNamesShort: ['天', '一', '二', '三', '四', '五', '六'], // For formatting
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		showAnim: 'drop', // Name of jQuery animation for popup
		...
		onClose: false, // Define a callback function when the datepicker is closed
